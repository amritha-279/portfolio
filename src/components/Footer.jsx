  ...
  return (
    <footer className="footer">
      <div className="footer-container">
        <p>&copy; <span id="year">{year}</span> Amritha. All rights reserved.</p>
        <div className="socials">
          <a href="https://www.linkedin.com/in/amritha-r-58aa40327" title="LinkedIn" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://github.com/amritha-279" title="GitHub" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
